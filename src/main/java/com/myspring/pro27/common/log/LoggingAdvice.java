...
public class LoggingAdvice {
	...
	public void startLog(JoinPoint jp) {
		...
		// 실행하는 대상 객체의 메서드에 대한 정보를 알아낼 때 사용합니다.
	...
	public Object timeLog(ProceedingJoinPoint pjp) throws Throwable {
		...
		// 실제 Target을 실행하는 부분이다. 이 부분이 없으면 advice가 적용된 메서드가 동작하지 않습니다.
		Object result = pjp.proceed(); // proceed는 Exception 보다 상위 Throwable을 처리하는

		long endTime = System.currentTimeMillis();
		// target 매서드의 동작 시간을 출력한다.
